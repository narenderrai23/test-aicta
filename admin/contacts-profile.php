                    ...
                    <div class="row g-0">
                                    ...
                                    <div class="py-4 text-start">
                                        <div class="text-center">
                                            <div class="profile-user-img">
                                                <img src="<?= $src ?>"
                                                    id="Profile" class="avatar-lg rounded-circle img-thumbnail">
                                            </div>
                                            <h5 class="mt-3 mb-1">
                                                <?= $data['name'] ?>
                                            </h5>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="row g-3" id="updateData">
                                        <div class="col-12">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body bg-body-tertiary">
                                    <form id="changePassword">
                                        ...
                                        <button class="btn btn-primary d-block w-100" type="submit">Update
                                            Password</button>
                                    </form>
                                </div>
                            </div>
                        ...
                        if (result.isConfirmed) {
                            ...
                            ajax("../php/controller/adminController.php", formData, function (response) {
                                if (response.status === true) {
                                    ...
                                    return Swal.fire({ icon: 'error', title: 'Error', text: 'Failed to update profile image. Please try again.' });
                                }
                            });
                        } else {
                            return Swal.fire({ icon: 'info', title: 'Info', text: 'Profile image update canceled.' });
                        }


                    } catch (error) {
                        console.error('Error:', error);
                        return Swal.fire({ icon: 'error', title: 'Error', text: 'An unexpected error occurred. Please try again.' });
                    }
                };
                reader.readAsDataURL(this.files[0]);
            } else {
                return Swal.fire({ icon: 'info', title: 'Info', text: 'Please select an image file.' });
            }
        });
