        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="../assets/image/favicon.png" alt="" height="22"> 
                        <span class="logo-txt"><?= $_SESSION['site_name'] ?></span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    $src = $imageDirectory . $_SESSION['profile_image'];
                    $src = (file_exists($src) && is_file($src) && getimagesize($src)) ? $src : "../assets/image/check.png"; ?>
                    <img src="<?= $src; ?>" alt="Profile Image" class="rounded-circle header-profile-user">
                </button>
