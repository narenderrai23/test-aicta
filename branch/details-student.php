                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <div class="card p-4 p-lg-0">
                                                <div class="row">
                                                    <div class="col-lg-12 col-4 px-lg-5">
                                                        <img src="../assets/upload/<?= $data->profile_image ?>" class="img-fluid rounded-start" alt="...">
                                                    </div>
                                                    <div class="col-lg-12 col-8">
                                                        <div class="card-body">
                                                            <table class="table table-striped table-bordered">
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-user text-primary"></i> Name</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-success"><?= $data->student_name; ?></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-id-card text-info"></i> Enrollment</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-secondary"><?= $data->enrollment; ?></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-book text-danger"></i> Course</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-warning"><?= $data->course_name; ?></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-phone text-info"></i> Student Phone</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-primary"><?= $data->student_phone; ?></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-calendar-alt text-danger"></i> Date Admission</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-warning"><?= $data->date_admission; ?></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <h6><i class="fas me-2 fa-calendar-alt text-info"></i> Date of Birth</h6>
                                                                    </td>
                                                                    <td>
                                                                        <span class="text-primary"><?= $data->student_dob; ?></span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
