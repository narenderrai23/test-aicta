...
$(window).on("load", function () {
  ...
  function initLeftMenuCollapse() {
    ...
    var verticalButton = $(".vertical-menu-btn");
    verticalButton.each(function (index) {
      $(this).on("click", function (event) {
        event.preventDefault();
        $("body").toggleClass("sidebar-enable");
        $("body").attr(
          "data-sidebar-size",
          $("body").attr("data-sidebar-size") == "lg" ? "sm" : "lg"
        );
      });
    });
  }
  ...
  function layoutSetting() {
    ...
    if (
      ...
      document.getElementsByClassName("vertical-menu")[0].style.display =
        "none";
      document.getElementsByClassName("ishorizontal-topbar")[0].style.display =
        "block";
