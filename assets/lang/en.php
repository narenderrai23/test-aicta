...
// Set the desired values for specific keys
$language['add-branch'] = "Add Branch";
$language['add-city'] = "Add City";
$language['add-course-category'] = "Add Course Category";
$language['add-courses'] = "Add Courses";
$language['branch-details'] = "Branch Details";
$language['course-details'] = "Course Details";
$language['dashboard'] = "Dashboard";
$language['edit-Branch-detail'] = "Edit Branch Detail";
$language['edit-city'] = "Edit City";
$language['edit-course'] = "Edit Course";
$language['index'] = "Index";
$language['login'] = "Login";
$language['logout'] = "Logout";
$language['manage-branch'] = "Manage Branch";
$language['manage-city'] = "Manage City";
$language['manage-courses'] = "Manage Courses";
$language['manage-students'] = "Manage Students";
$language['profile'] = "Profile";
$language['session'] = "Session";
$language['add-students'] = "Add Students";
$language['student-profile'] = "Student Profile";
$language['edit-student'] = "Edit Student";
